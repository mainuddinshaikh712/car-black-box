...
void login_screen(void)
{
    ...
    if(E_P_T >= 0 )
    {
        ...
        if(pass_count < 4)
        {
            clcd_print("_Enter password_",(0x80 + (0)));
            if (U_S++ < 200)
            {
               clcd_putch('_',(0xC0 + (pass_count)));
            }
            else if(U_S++ >200 && U_S < 400)
            {
                clcd_putch(' ',(0xC0 + (pass_count)));
            }
            else
                U_S =0;
    ...
    else
    {
        clcd_write(0x01, 0);
        main_flag=0;
        GIE=0;E_P_T=4;at_fail=120;
        attempt=1;U_S=0; pass_count=0; pass_complet=0;
        return;
    }
        if(pass_complet)
        {
            ...
            else if(attempt < 3)
            {
                ...
                clcd_putch((char)(3-attempt)+48,(0xC0 + (13)));
                ...
                while(1)
                    {
                        ...
                        clcd_putch((at_fail%10)+48,(0xC0 + (2)));
                        clcd_putch((at_fail/10)%10 + 48,(0xC0 + (1)));
                        clcd_putch(((at_fail/100)%10) + 48,(0xC0 + (0)));
                        clcd_print("... sec",(0xC0 + (3)));
                        if(at_fail == 0 )
                        {
                            clcd_write(0x01, 0);
                            GIE = 0;at_fail=120;
...
void main_menu(void)
{
    ...
    if (key == (char*)11 )
    {
        ...
        {
            clcd_write(0x01, 0);
            clcd_print("entered in",(0x80 + (0)));
            clcd_print(menu[count],(0xC0 + (0)));
            main_flag = (count+10);
    ...
    clcd_print(menu[j],(0x80 + (1)));
    clcd_print(menu[j+1],(0xC0 + (1)));
}
...
void change_password(void)
{
    ...
    static unsigned long int delay1=0, delay2=0;
    static unsigned int pass_count=0, pass_count2=0,cs_f=0;
    ...
    if (pass_count > 3 && pass_count2 > 3)
    {
        ...
        {
            clcd_write(0x01, 0);
            clcd_print("pass_mismatch",(0x80 + (0)));
            _delay((unsigned long)((1500)*(20000000/4000.0)));
            clcd_write(0x01, 0);
            delay1=0;delay2=0;pass_count=0;pass_count2=0;cs_f=0;
            main_flag=2;
...
void set_time(void)
{
     ...
     if (key == (char*)11 )
    {
        if(++delay1 >= 500 )
        {
            ...
            time[6] = ((sec/10) + 48);
            time[7] = ((sec%10) + 48);
            write_ds1307(0x02,(time[0]<<4)| (time[1]&0x0f));
            write_ds1307(0x01,(time[3]<<4)| (time[4]&0x0f));
            write_ds1307(0x00,(time[6]<<4)| (time[7]&0x0f));
